...
\item Бинарная операция $*$: $\mathbb{R} \times \mathbb{R} \rightarrow \mathbb{R}$ удовлетворяет соотношению 
$$(a * b) * c = a + b + c$$
для любых вещественных чисел $a$, $b$ и $c$. Докажите, что $a * b = a + b$ для любых вещественных $a$ и $b$.
